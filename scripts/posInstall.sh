...
myBaseHyprland="hyprland wofi waybar hyprlock hyprpaper hyprpicker wl-clipboard wlroots xdg-desktop-portal-hyprland grim slurp azote swaybg polkit-gnome acpilight nwg-look lxappearance xfce4-taskmanager gpicview font-manager pcmanfm galculator system-config-printer xreader cmus dragon kdeconnect gnome-keyring seahorse leafpad network-manager-applet pavucontrol blueman"
...
myBaseNvidia="dkms nvidia-open nvidia-open-dkms xorg-server xorg-xinit nvidia-settings nvidia-utils lib32-nvidia-utils libva-nvidia-driver cuda opencl-nvidia lib32-opencl-nvidia vdpauinfo clinfo"
