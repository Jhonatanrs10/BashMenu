...
myBspwm="bspwm sxhkd scrot polybar rofi picom nitrogen acpilight xcolor"
myI3wm="i3 polybar i3lock i3status dmenu rofi picom nitrogen acpilight scrot xcolor"
myWmApps="nwg-look lxrandr xfce4-taskmanager gpicview xfce4-power-manager font-manager pcmanfm galculator system-config-printer ark xreader rhythmbox dragon kdeconnect gnome-keyring seahorse leafpad network-manager-applet volumeicon pavucontrol blueman"
