...
myHyprland="hyprland wofi waybar hyprlock hyprpicker wl-clipboard xorg-xhost egl-wayland azote swaybg blueman pavucontrol network-manager-applet gnome-keyring seahorse"
