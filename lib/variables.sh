...
myBaseHyprland="hyprland wofi waybar hyprlock hyprpaper hyprpicker wl-clipboard wlroots xdg-desktop-portal-hyprland grim slurp azote swaybg swaylock polkit-gnome nwg-look lxappearance xfce4-taskmanager gpicview font-manager pcmanfm galculator system-config-printer xreader cmus dragon gnome-keyring seahorse leafpad network-manager-applet pavucontrol blueman"
myBaseBspwm="bspwm sxhkd polkit-gnome polybar rofi picom feh scrot xcolor nwg-look lxappearance lxrandr xfce4-taskmanager gpicview xfce4-power-manager font-manager pcmanfm galculator system-config-printer xreader cmus dragon gnome-keyring seahorse leafpad network-manager-applet pavucontrol blueman"
myBaseI3wm="i3 i3lock xss-lock i3status dmenu polkit-gnome polybar rofi picom feh scrot xcolor nwg-look lxappearance lxrandr xfce4-taskmanager gpicview xfce4-power-manager font-manager pcmanfm galculator system-config-printer xreader cmus dragon gnome-keyring seahorse leafpad network-manager-applet pavucontrol blueman"
myBaseGlobalApps="gimp inkscape shotcut code neovim qbittorrent mpv gparted chromium alacritty bitwarden discord ark libreoffice-fresh kdeconnect"
myBaseSteam="steam"
