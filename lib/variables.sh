...
myBaseHyprland="hyprland wofi waybar hyprlock hyprpaper hyprpicker wl-clipboard wlroots xdg-desktop-portal-hyprland grim slurp azote swaybg swaylock polkit-gnome acpilight nwg-look lxappearance xfce4-taskmanager gpicview font-manager pcmanfm galculator system-config-printer xreader cmus dragon gnome-keyring seahorse leafpad network-manager-applet pavucontrol blueman"
myBaseBspwm="bspwm sxhkd polkit-gnome polybar rofi picom feh acpilight scrot xcolor nwg-look lxappearance lxrandr xfce4-taskmanager gpicview xfce4-power-manager font-manager pcmanfm galculator system-config-printer xreader cmus dragon gnome-keyring seahorse leafpad network-manager-applet pavucontrol blueman"
...
myBaseIntelOld="vulkan-intel libva-intel-driver libvdpau-va-gl"
myBaseIntel="xf86-video-intel vulkan-intel libva-intel-driver libvdpau-va-gl"
