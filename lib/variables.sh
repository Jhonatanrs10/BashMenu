...
myBaseXorgWmApps="polkit-gnome polybar rofi picom feh scrot xcolor nwg-look lxappearance lxrandr xfce4-taskmanager gpicview xfce4-power-manager font-manager pcmanfm galculator system-config-printer xreader cmus dragon gnome-keyring seahorse leafpad network-manager-applet pavucontrol blueman"
