...
myBaseXorgWmApps="polkit-gnome polybar rofi picom feh scrot xcolor nwg-look lxappearance lxrandr xfce4-taskmanager gpicview font-manager pcmanfm galculator system-config-printer xreader cmus dragon gnome-keyring seahorse leafpad network-manager-applet pavucontrol blueman"
myBaseHyprland="hyprland wofi waybar hyprlock hyprpaper hypridle hyprpicker wl-clipboard wlroots xdg-desktop-portal-hyprland grim slurp azote swaybg swaylock polkit-gnome nwg-look lxappearance xfce4-taskmanager gpicview font-manager pcmanfm galculator system-config-printer xreader cmus dragon gnome-keyring seahorse leafpad network-manager-applet pavucontrol blueman"
