...
myBaseXorgWmApps="polkit-gnome polybar rofi picom feh scrot xcolor nwg-look lxappearance lxrandr gpicview font-manager pcmanfm galculator system-config-printer xreader cmus dragon gnome-keyring seahorse leafpad network-manager-applet pavucontrol blueman"
myBaseHyprland="hyprland wofi waybar hyprlock hyprpaper hypridle hyprpicker wl-clipboard xdg-desktop-portal-hyprland grim slurp azote swaybg swaylock polkit-gnome nwg-look lxappearance gpicview font-manager pcmanfm galculator system-config-printer xreader cmus dragon gnome-keyring seahorse leafpad network-manager-applet pavucontrol blueman"
myBaseBspwm="bspwm sxhkd"
...
myBaseFirewall="gufw"
myBaseUtilitys="nano brightnessctl fastfetch stow curl jq imagemagick cmatrix htop xsel pacman-contrib base-devel git ffmpeg fwupd samba udisks2 gvfs gvfs-mtp gvfs-smb polkit net-tools joyutils man-db wireless_tools"
